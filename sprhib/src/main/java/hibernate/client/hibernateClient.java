...
//		StudentId id = (StudentId) ses.save(new Student(new StudentId(1, 2025), "Abc", "Def", "CS", 8735916655L,
//				new StudentAddress("Parimal", "Ahm", 3432432)
//				, new StudentAddress("Bgkt", "Raj", 563444)));
...
//		ses.update(car);
//		ses.flush();     // dont call session on flush on your own
//		System.out.println(car);
